  ...
  return (
    <div className="min-h-screen pb-32 font-sans bg-background text-text">
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
        <div className="absolute top-[10%] -left-[10%] w-[300px] h-[300px] rounded-full bg-violet-500/5 blur-[80px]" />
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Atom className="w-3 h-3 text-violet-500" />
              <p className="text-[10px] font-extrabold tracking-[0.22em] uppercase text-violet-500">
                Quantum Engine
              </p>
            </div>
